...
完整技术文档见 [docs/TECH.md](docs/TECH.md)(V2.0,第 24/25 章为两大
...
| docs/TECH.md | 工程师 | 完整技术文档(V2.0;第 24 章 HEVC 补丁工程、第 25 章提示词约束工程) |
...
硬约束。维护者改任何提示词前先读本表(完整实现见 TECH.md 第 25 章)。
...
- **回复路由三分类**(2026-08-13 泄露根治):`agent:send` source =
  ...
  防重发快照:本轮已用 send 工具发过则跳过路由。改路由逻辑前先读 TECH.md 13.7。
